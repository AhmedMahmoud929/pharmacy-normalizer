...
import { Sliders, History, Database, Terminal } from "lucide-react";
...
export default function CrawlerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <CrawlerProvider>
      <div className="w-full min-w-0 font-sans selection:bg-primary-dark selection:text-primary-foreground">
        <FeatureBadge icon={Terminal} label={tDash("badge_crawler")} />
        <div className="mb-8">
            ...
            <div>
              <div className="relative flex items-center gap-2 py-2">
                ...
                <Image
                  ...
                  width={150}
                  height={130}
                  className="brightness-300 hue-rotate-[-60deg] mb-1"
                />
              ...
              <Link
                ...
                className={`flex items-center gap-2 px-4 py-2 text-xs font-semibold rounded-md transition-all duration-300 ${
                  activeTab === "orchestrate"
                    ? "bg-primary-dark text-primary-foreground shadow-lg shadow-primary-deep/10"
