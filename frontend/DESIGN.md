...
- **Border Subtle** (`rgba(113, 50, 245, 0.5)`): Primary themed borders (Tailwind: `border-primary/50`)
- **Border Dark Mode** (`rgba(113, 50, 245, 0.3)`): Subtle themed borders for dark mode (Tailwind: `border-primary/30`)
